...
/***/ function(module, exports, __webpack_require__) {
	...
	var Katakata = function () {
	  function Katakata(config) {
	    (0, _classCallCheck3.default)(this, Katakata);
	
	    this.setConfig(config.target, config.text, config.devider, config.intervalMinMSec, config.intervalMaxMsec, config.debug);
	  }
	
	  (0, _createClass3.default)(Katakata, [{
	    key: 'setConfig',
	    value: function setConfig() {
	      ...
	      var intervalMinMSec = arguments.length <= 3 || arguments[3] === undefined ? 100 : arguments[3];
	      var intervalMaxMsec = arguments.length <= 4 || arguments[4] === undefined ? 400 : arguments[4];
	    ...
	    key: 'typeGenerate',
	    value: _regenerator2.default.mark(function typeGenerate() {
	      return _regenerator2.default.wrap(function typeGenerate$(_context) {
	        while (1) {
	    ...
	    value: function typingController(promise) {
	      ...
	      promise.then(function () {
	        _this2.typingController(_this2.typeCharPromise());
	      });
	    }
	  }, {
	    key: 'typeCharPromise',
	    value: function typeCharPromise() {
	      ...
	      return new _promise2.default(function (resolve, reject) {
	        var result = _this3.typingMachine.next();
	
	        // 必要であればセルを配置 
	        _this3.setCellIfNecesasry();
	        ...
	        // 表示を更新
	        _this3.enterOrType(result, resolve);
	      });
	    }
	  }, {
	    key: 'setCellIfNecesasry',
	    value: function setCellIfNecesasry() {
	    ...
	    key: 'enterOrType',
	    value: function enterOrType(result, resolve) {
	    ...
	    key: 'type',
	    value: function type(result, resolve) {
	      var _this4 = this;
	
	      setTimeout(function () {
	        _this4.typingBase(result['value']['char']);
	        resolve();
	      }, result['value']['interval']);
	    }
	  }, {
	    key: 'enter',
	    value: function enter(resolve) {
	      var _this5 = this;
	
	      setTimeout(function () {
	        _this5.activeCell.classList.remove('on-edit');
	        if (resolve == null) {
	          return;
	        } else {
